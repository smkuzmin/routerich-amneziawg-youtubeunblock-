...
# 13. Добавляем маршруты к Telegram через интерфейс awg0 в таблице main
...
check "Шаг 3/13: Добавляем маршруты к Telegram через awg0 в таблице main"                 "ip route show table main | grep awg0 | grep '91.105.192.0/23'"
